...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Family" value="1~~1~~CASE&#xa;WHEN $scale &lt; 3000 THEN 'Cadastra'&#xa;ELSE 'CadastraCondensed'&#xa;END~~"/>
    <property key="labeling/dataDefined/FontStyle" value="1~~1~~CASE &#xa;WHEN &quot;kategorie&quot; = 'Flurname' THEN CASE WHEN $scale &lt; 3000 THEN 'Italic'  ELSE 'Oblique' END&#xa;WHEN  &quot;kategorie&quot;  =  'Gelaendename' THEN 'Regular'&#xa;WHEN  &quot;kategorie&quot;  =  'Ortsname' THEN 'Bold'&#xa;END~~"/>
    ...
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE &#xa;WHEN $scale &lt; 750 THEN 22.4&#xa;WHEN $scale >= 750 AND $scale &lt; 1250 THEN 16&#xa;WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 11.2&#xa;WHEN $scale >= 3000 THEN 8.8&#xa;END~~"/>
