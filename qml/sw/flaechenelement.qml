...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{e8f8a35a-2bc6-4443-9afd-5bb77607fec6}">
      <rule filter="&quot;typ&quot; IN ('Aussichtsturm', 'Bahnsteig', 'Bruecke_Passarelle', 'Brunnen', 'einzelner Fels', 'Hochkamin', 'Landungssteg', 'massiver_Sockel', 'Mast_Antenne', 'Mauer', 'Pfeiler', 'Ruine_archaeologisches_Objekt', 'Schwelle', 'Silo_Turm_Gasometer', 'Uferverbauung', 'wichtige_Treppe')" key="{7ae052b4-3125-4690-9741-bb314439befd}" symbol="0" label="ausgezogen"/>
      <rule filter="&quot;typ&quot; IN ('schmale_bestockte_Flaeche', 'uebriger_Gebaeudeteil', 'Unterstand')" key="{d4d31432-7b46-44b9-a7ee-b31faf7505d9}" symbol="1" label="gestrichelt2"/>
      <rule filter="&quot;typ&quot; = 'schmaler_Weg'" key="{7f1b8227-bc5b-43f4-af8a-c685003e52dc}" symbol="2" label="gestrichelt2_schmaler_Weg"/>
      <rule filter="&quot;typ&quot;  IN ('eingedoltes_oeffentliches_Gewaesser', 'Reservoir', 'Tunnel_Unterfuehrung_Galerie', 'unterirdisches_Gebaeude')" key="{97c55c30-27d2-47fb-abba-f7d69fb0a5b9}" symbol="3" label="punktiert"/>
    </rules>
    <symbols>
